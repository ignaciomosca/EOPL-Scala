...
object Expression {
  case class ConstExpr(value: ExpVal) extends Expression
  ...
  case class LetrecExpr(pname: String, bvar: String, pbody: Expression, letrecBody: Expression) extends Expression
}
